...
SegmentadorSOM: main.o ControladorSegmentadorSOM.o Controlador.o Calculos.o Dado.o ConjuntoDados.o Neuronio.o Arranjo.o SOM.o MapaContextual.o Visualizacao.o
	g++ -fopenmp main.o ControladorSegmentadorSOM.o Controlador.o Calculos.o Dado.o ConjuntoDados.o Neuronio.o Arranjo.o SOM.o MapaContextual.o Visualizacao.o -o SegmentadorSOM

main.o: main.cpp ./Controlador/ControladorSegmentadorSOM.h
	g++ -std=c++17 -fopenmp -O3 -c -Wall -Wextra -pedantic main.cpp -o main.o

ControladorSegmentadorSOM.o: ./Controlador/ControladorSegmentadorSOM.cpp ./Controlador/ControladorSegmentadorSOM.h ./Controlador/Controlador.h ./Codificador/Dado.h ./Codificador/ConjuntoDados.h ./SOM/Neuronio.h ./SOM/Arranjo.h ./SOM/SOM.h ./Visualizacao/MapaContextual.h
...
# Comando completo
# g++ -std=c++17 -fopenmp -O3 -Wall -Wextra -pedantic main.cpp ./Controlador/ControladorSegmentadorSOM.cpp ./Controlador/Controlador.cpp ./Calculos/Calculos.cpp ./Codificador/Dado.cpp ./Codificador/ConjuntoDados.cpp ./SOM/Neuronio.cpp ./SOM/Arranjo.cpp ./SOM/SOM.cpp ./Visualizacao/MapaContextual.cpp ./Visualizacao/Visualizacao.cpp -o SegmentadorSOM
