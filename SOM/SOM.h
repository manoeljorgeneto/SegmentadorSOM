...
class SOM {
    ...
    void Verboso(unsigned int msg, bool verboso = true, unsigned int iteracoes = 0, unsigned int n_it = 0,
                 int64_t tempo = 0);
...
public:
	...
	void treinaSOM(vector<Dado*>* dados, unsigned int iteracoes = 10000, bool inicializa = true, bool verboso = true);
    ...
    void sumario(); // Faz um sumário do SOM
};
